...
class MotorsAbstractor:
    ...
    def __init__(self, parsed_joint_params, new_angle=0):
        ...
        self.motor_controller = mot_con.CanMotorController(self.can_params, self.motor_params, self.joint_name)
        '''
        ROS entities
        '''
    ...
    def publish_latest_status(self, status_handler):
        ...
        latest_pos, latest_vel, latest_torque = status_handler.get_status(self.can_params.can_id)
